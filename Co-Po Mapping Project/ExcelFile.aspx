<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ExcelFile.aspx.cs" Inherits="Co_Po_Mapping_Project.ExcelFile" %>
            ...
            <aside class="sidebar">
                ...
                <nav class="menu">
                    <ul>
                        ...
                        <li><i class="fa-solid fa-magnifying-glass"></i> <a href="MappingTool.aspx">Mapping Tool</a></li>
                        <li><i class="fa-solid fa-file-pdf"></i> <a href="Analysis_Report.aspx">Analysis & Report</a></li>
                        <li><i class="fa-solid fa-magnifying-glass-chart"></i> <a href="View_Graphs.aspx">View Graphs</a></li>
